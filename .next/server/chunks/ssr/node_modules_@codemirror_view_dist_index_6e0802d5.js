...
function groupAt(state, pos, bias = 1) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].undirectionalRange(from + line.from, to + line.from);
}
...
function moveVertically(view, start, forward, distance) {
    ...
    for(let scan = 0;; scan += halfText){
        ...
        if (forward ? y > rect.bottom : y < rect.top) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos.pos, pos.assoc);
        let posCoords = view.coordsAtPos(pos.pos, pos.assoc), mid = posCoords ? (posCoords.top + posCoords.bottom) / 2 : 0;
        if (!posCoords || (forward ? mid > startY : mid < startY)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos.pos, pos.assoc, undefined, goal);
    }
}
    ...
    for(let i = 0; i < sel.ranges.length; i++){
        ...
        if (range.empty) {
            ...
            if (from != range.from || to != range.to) {
                if (range.undirectional) updated = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].undirectionalRange(range.from, range.to);
                else updated = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].range(range.from == range.anchor ? from : to, range.from == range.head ? from : to);
            }
        }
        if (updated) {
    ...
    constructor(view, start, end, typeOver){
        ...
        if (view.state.readOnly && start > -1) {
            ...
            if (view.inputState.composing > -1 && curSel.ranges.length > 1) {
                this.newSel = curSel.replaceRange(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].range(anchor, head));
                ...
                this.newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].create([
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(head, assoc)
                ]);
            } else {
...
function rangeForClick(view, pos, bias, type) {
    if (type == 1) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].undirectionalRange(from, to);
    }
}
    ...
    return {
        ...
        get (event, extend, multiple) {
            ...
            if (start.pos != cur.pos && !extend) {
                ...
                range = from < range.from ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].range(from, to, range.assoc) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].range(to, from, range.assoc);
            }
...
handlers.dragstart = (view, event)=>{
    ...
    if (event.target.draggable) {
        ...
        if (tile && tile.isWidget()) {
            ...
            if (from >= range.to || to <= range.from) range = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].undirectionalRange(from, to);
        }
    }
    let { inputState } = view;
...
*/ class EditorView {
        ...
        try {
            ...
            for (let tr of transactions){
                ...
                if (tr.scrollIntoView) {
                    ...
                    scrollTarget = new ScrollTarget(main.empty ? main : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(main.head, main.head > main.anchor ? -1 : 1), "nearest", "nearest", y, x);
                }
    ...
    */ static scrollIntoView(pos, options = {}) {
        var _a, _b, _c, _d;
        return scrollIntoView.of(new ScrollTarget(typeof pos == "number" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos) : pos, (_a = options.y) !== null && _a !== void 0 ? _a : "nearest", (_b = options.x) !== null && _b !== void 0 ? _b : "nearest", (_c = options.yMargin) !== null && _c !== void 0 ? _c : 5, (_d = options.xMargin) !== null && _d !== void 0 ? _d : 5));
    }
    /**
...
*/ EditorView.cursorScrollMargin = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (inputs)=>{
        let x = 5, y = 5;
        for (let i of inputs){
    ...
    markers (view) {
        ...
        for (let r of state.selection.ranges){
            ...
            if (r.empty || conf.drawRangeCursor && !(prim && browser.ios && conf.iosSelectionHandles)) {
                ...
                let cursor = r.empty ? r : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(r.head, r.assoc);
...
const selectionLayer = /*@__PURE__*/ layer({
    ...
    markers (view) {
        ...
        if (browser.ios && !main.empty && view.state.facet(selectionConfig).iosSelectionHandles) {
            for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-start", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(main.from, 1)))markers.push(piece);
            for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-end", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(main.to, 1)))markers.push(piece);
        }
        return markers;
    },
    update (update, dom) {
...
const hoverPlugin = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Facet"].define();
class HoverPlugin {
