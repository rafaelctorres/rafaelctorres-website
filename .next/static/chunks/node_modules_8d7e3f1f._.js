    ...
    "../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/MemoryLeakError.js" (exports) {
        ...
        var MemoryLeakError = class extends Error {
            constructor(emitter, type, count){
                super("Possible EventEmitter memory leak detected. ".concat(count, " ").concat(type.toString(), " listeners added. Use emitter.setMaxListeners() to increase limit")), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "emitter", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "count", void 0);
...
function createDebug(scope) {
    return function debug3(message) {
        for(var _len = arguments.length, data = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
            data[_key - 1] = arguments[_key];
        }
        if (FLAG === "true") {
            const direction = ()=>{
                if (message.includes("sender")) return "".concat(GREEN, "sender");
                if (message.includes("receiver")) return "".concat(RED, "receiver");
                return "";
            };
            const cleanMessage = message.replace(/\[.+\]:/, "");
            console.debug("".concat(COLOR_SCOPE[scope]).concat(scope, ":").concat(direction()).concat(DEFAULT, ":").concat(cleanMessage), ...data);
        }
    };
}
// src/messages.ts
...
var MessageReceiver = class {
    ...
    constructor(){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "senderPort", null);
...
var MessageSender = class {
    ...
    constructor(target){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "emitter", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "channel", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "receiverPort", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "receiverReadyPromise", void 0);
        this.target = target;
        this.emitter = new EventTarget();
...
var FileSystemApi = class {
    ...
    async watch(includes, excludes, listener) {
        ...
        this.channel.on("fs/watch-event", (param)=>{
            let { data } = param;
...
var ShellProcess = class {
    ...
    async on(message, listener) {
        switch(message){
            case "progress":
                {
                    this.channel.on("worker/progress", (param)=>{
                        let { data } = param;
            ...
            case "exit":
                {
                    this.channel.on("worker/exit", (param)=>{
                        let { data } = param;
                        if (data.workerId === this.id) {
    ...
    constructor(channel){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "stdin", void 0);
        this.channel = channel;
        this.state = "running";
...
var PreviewApi = class {
    async waitFor(payload, predicate) {
        let timeout = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : TIMEOUT;
        ...
        this.channel.on("preview/port/ready", (param)=>{
            let { data } = param;
...
var Nodebox = class {
    ...
    constructor(options){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "channel", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isConnected", void 0);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "fileSystemApi", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "shellApi", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "previewApi", null);
...
//# sourceMappingURL=node_modules_8d7e3f1f._.js.map