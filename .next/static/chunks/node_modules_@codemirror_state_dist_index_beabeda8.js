...
*/ class SelectionRange {
    ...
    */ extend(from) {
        let to = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : from, assoc = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
...
function flatten(extension, compartments, newCompartments) {
    ...
    function inner(ext, prec) {
        ...
        if (Array.isArray(ext)) {
            ...
            if (!content) throw new Error("Unrecognized extension value in extension set (".concat(ext, ")."));
            if (content == ext) throw new Error("Unrecognized extension value in extension set (".concat(ext, "). This sometimes happens because multiple instances of @codemirror/state are loaded, breaking instanceof checks."));
            inner(content, prec);
        }
    }
